"""
Seed full SEO content (EN + LV, all five fields) for the
Displays & Projectors subtree.

Ten nodes total: the displays-projectors root, the
large-format-displays-video-walls and projectors intermediates plus their
leaves, and the standalone monitors and monitor-accessories leaves.

The first H2 in every bottom_seo here is a long descriptive title that
includes the category name (replacing the generic "Category overview"
heading used in earlier migrations).
...
DATA_FILE = Path(__file__).with_name("012_seed_displays_seo.json")
FIELDS = (
