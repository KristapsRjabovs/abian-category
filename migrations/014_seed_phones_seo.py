"""
Seed full SEO content (EN + LV, all nine fields) for the
Phones & Tablets (phones-tabels) subtree.

Sixteen nodes total: the phones-tabels root, the mobile-phones,
smartphone-accessories, tablets, tablet-accessories, telephones,
wearable-electronics intermediates and leaves, plus all leaf
nodes under smartphone-accessories and telephones.
...
DATA_FILE = Path(__file__).with_name("014_seed_phones_seo.json")
FIELDS = (
